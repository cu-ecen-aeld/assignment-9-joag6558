...
QEMU_DEFCONFIG=${EXTERNAL_REL_BUILDROOT}/buildroot/configs/qemu_aarch64_virt_defconfig
# The place we store customizations to the qemu configuration
MODIFIED_QEMU_DEFCONFIG=${EXTERNAL_REL_BUILDROOT}/configs/aesd_qemu_defconfig
...
AESD_MODIFIED_DEFCONFIG_REL_BUILDROOT=${MODIFIED_QEMU_DEFCONFIG}
